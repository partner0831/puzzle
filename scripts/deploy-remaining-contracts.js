...
async function main() {
  console.log("🚀 Deploying Remaining Pizza Party Smart Contracts to Base Network...");
  ...
  try {
    // 1. Deploy SecureReferralSystem contract
    console.log("\n🔗 1. Deploying SecureReferralSystem contract...");
    ...
    // 2. Deploy ChainlinkVRF contract
    console.log("\n🎲 2. Deploying ChainlinkVRF contract...");
    ...
    // 3. Deploy PizzaPartyCore contract (the smaller, deployable version)
    console.log("\n🍕 3. Deploying PizzaPartyCore contract...");
    ...
    // 4. Try to deploy the full PizzaParty contract (may fail due to size)
    console.log("\n🍕 4. Attempting to deploy full PizzaParty contract...");
    try {
    ...
    // 5. Deploy MockVMF contract (for testing)
    console.log("\n🧪 5. Deploying MockVMF contract...");
    ...
    const verificationPromises = [
      ...
      hre.run("verify:verify", {
        ...
        constructorArguments: [randomnessAddress],
