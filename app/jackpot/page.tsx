  ...
  const handleClaimToppings = async () => {
    ...
    try {
      ...
      if (confirmed) {
        ...
        console.log(`🏆 Claiming ${userClaimableToppings} toppings for ${connection.address}`)
          ...
          <CardContent className="space-y-5">
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-orange-500 p-3 rounded-xl border-4 border-yellow-600 text-center">
              ...
              <p className="text-white text-4xl font-black flex items-center justify-center" style={customFontStyle}>
                <img src="/images/star-favicon.png" alt="Star" className="w-8 h-8 rounded-full mx-2" />
            ...
            <div className="text-center">
              ...
              {isConnected && userClaimableToppings > 0 && !canClaim && (
                <div className="text-xs text-orange-600 mt-2" style={customFontStyle}>
                  <p>⏰ Next claiming window in:</p>
                  <p>{timeUntilClaiming.days}d {timeUntilClaiming.hours}h {timeUntilClaiming.minutes}m {timeUntilClaiming.seconds}s</p>
                </div>
              )}
            </div>
            ...
            {!isDrawComplete ? (
              ...
              <div className="bg-green-50 p-4 rounded-xl border-2 border-green-200">
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <p className="font-semibold text-green-800 text-center" style={customFontStyle}>
                    🏆 Jackpot Winners! 🏆
                  </p>
                </div>
                <div className="space-y-2">
                  {winners.map((winner, index) => (
                    <div key={winner} className="bg-white p-2 rounded border border-green-300">
                      <p className="text-sm text-green-700 text-center" style={customFontStyle}>
                        <strong>Winner {index + 1}:</strong> {winner.slice(0, 6)}...{winner.slice(-4)}
                      </p>
                      <p className="text-xs text-green-600 text-center" style={customFontStyle}>
                        Paid: {Math.floor(totalVMFInJackpot / winners.length)} VMF
                      </p>
                    </div>
                  ))}
                </div>
                <p className="text-xs text-green-600 text-center mt-2" style={customFontStyle}>
                  VMF automatically sent from contract: 0x2213414893259b0c48066acd1763e7fba97859e5
                </p>
              </div>
            )}
            ...
            <div className="flex justify-center">
              <div className="bg-blue-800 rounded-xl text-center w-full h-10 flex items-center justify-center border-2 border-blue-700">
                ...
                <p className="text-base text-white mr-2" style={customFontStyle}>
                  Weekly Players
                </p>
                <p className="text-base font-bold text-white" style={customFontStyle}>
            ...
            <div className="bg-gray-50 p-4 rounded-xl border-2 border-gray-200">
              ...
              <ul className="space-y-2 text-sm text-gray-700" style={customFontStyle}>
                ...
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span><strong>Hold VMF tokens:</strong> 3 toppings for every 10 VMF in wallet</span>
                </li>
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-yellow-50 p-4 rounded-xl border-2 border-yellow-200">
              ...
              <ul className="space-y-1 text-xs text-yellow-700" style={customFontStyle}>
                ...
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span><strong>Prerequisite to qualify:</strong> Must hold minimum VMF tokens to participate</span>
                </li>
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span><strong>Daily Jackpot:</strong> 8 winners randomly selected from today's players at 12pm PST daily. VMF automatically paid from contract</span>
                </li>
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span><strong>Weekly Jackpot:</strong> 10 winners randomly selected with weighted probability based on toppings at Monday 12pm PST. VMF automatically paid from contract</span>
                </li>
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <img src="/images/pepperoni-art.png" alt="Pepperoni" className="w-4 h-4 mt-0.5 flex-shrink-0" />
                  <span><strong>Weekly jackpot equals total toppings claimed, paid in VMF:</strong> 1 topping = 1 VMF in prize pool</span>
                </li>
              </ul>
            </div>
          </CardContent>
